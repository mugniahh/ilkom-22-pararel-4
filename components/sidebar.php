<aside class="main-sidebar sidebar-dark-gray elevation-4" style="background-color:#1E56A0 !important;">
    <!-- Brand Logo -->
    <a href="#" class="brand-link" style="border-bottom:1px solid white !important;">
        <i class="fas fa-regular fa-stethoscope"></i>
        <span class="brand-text font-weight-bold text-white">Heathcare</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
        <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-bottom:1px solid white !important;width:100%;">
            <div class="image">
            ...
            <div class="info">
                ...
                <a href="#" class="d-block text-white"><b><?php echo $resultData['nama'] ?></b></a>
            </div>
        </div>
