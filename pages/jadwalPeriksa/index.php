                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <?php
                                ...
                                $queryDataPasien = "SELECT pasien.nama, daftar_poli.keluhan, daftar_poli.status_periksa, daftar_poli.id, 
                                                    daftar_poli.no_antrian FROM daftar_poli 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($data['status_periksa'] == 1) { ?>
                                            ...
                                            <a href='invoice.php?id=<?php echo $data['id'] ?>' class='btn btn-sm btn-secondary edit-btn mx-1'>Invoice</a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php
                                                                ...
                                                                $ambilDataPeriksa = mysqli_query($mysqli, "SELECT * FROM periksa 
                                                                    INNER JOIN daftar_poli ON periksa.id_daftar_poli = daftar_poli.id 
                                                                    WHERE daftar_poli.id = '$idPendaftaranPoli'");
                                        ...
                                        <?php } else { ?>
                                            <!-- Periksa Button -->
                                            <button type='button' class='btn btn-sm btn-success edit-btn' data-toggle="modal" data-target="#periksaModal<?php echo $data['id'] ?>">Periksa</button>

                                            <!-- Modal for Periksa -->
                                            <div class="modal fade" id="periksaModal<?php echo $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="periksaModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
