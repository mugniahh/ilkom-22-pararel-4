...
- Sebagai seorang Pasien, saya ingin mendaftar sebagai pasien Heathcare. Saya bersedia menginformasikan data diri saya, sehingga saya memenuhi persyaratan sebagai seorang pasien dan mendapat no rekam medis.
- **Memeriksa Pasien**
...
1. Klon repository: `git clone git@github.com:Bengkel-Koding-Web/bk-Heathcare.git`

2. Siapkan server web (misalnya, Apache) dan konfigurasikan agar menunjuk ke direktori publik proyek.

3. Impor skema database dari `Heathcare.sql` ke database MySQL Anda.
